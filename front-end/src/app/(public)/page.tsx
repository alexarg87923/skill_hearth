	...
	<main className="flex min-h-screen flex-col items-center justify-top p-12 mt-8">
		...
		<section className="bg-gray-100 dark:bg-black py-12 px-6 mt-12 w-full">
			...
			<div className="flex justify-center space-x-4">
				<Link href="/#" className="bg-blue-600 hover:bg-blue-800 text-white font-semibold py-3 px-6 rounded-lg">
				Learn More
				</Link>
				<Link href="/#" className="bg-blue-600 hover:bg-green-800 text-white font-semibold py-3 px-6 rounded-lg">
				Get Started
				</Link>
			</div>
			</div>
