        ...
        <section className="bg-gray-100 dark:bg-black py-12 px-6 mt-12 w-full">
          <div className="max-w-screen-xl mx-auto text-center">
            ...
            <div className="flex justify-center space-x-4">
              <Link href="/learn-more" className="bg-blue-600 hover:bg-blue-800 text-white font-semibold py-3 px-6 rounded-lg">
                Learn More
              </Link>
              <Link href="/get-started" className="bg-blue-600 hover:bg-green-800 text-white font-semibold py-3 px-6 rounded-lg">
                Get Started
              </Link>
            </div>
          </div>
