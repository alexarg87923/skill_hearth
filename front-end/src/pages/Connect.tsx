		...
		<div className="h-screen flex justify-center bg-gray-900 text-gray-100 pt-16 items-center p-4">
		          <div className='w-full max-w-7xl'>
		              ...
		              {recommendedUsers.map((profile, index) => (
		                  <div className='group items-center bg-gray-800 rounded-xl transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-2xl hover:ring-2 hover:ring-gray-600 flex-col shadow-lg' key={index}>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex gap-2" key={index}>
                                    {profile.interests.map((interest, index) => (        
                                        <span key={index} className='bg-blue-500 rounded-md text-xl p-1'>{interest}</span>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex flex-wrap gap-2" key={index}>
                                    {profile.skills.map((skill, index) => (        
                                        <span key={index} className='bg-orange-500 rounded-md text-xl p-1'>{skill}</span>
                                    ))}
                                </div>
                            </div>
