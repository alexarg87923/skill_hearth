    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-24">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                />
                <ul
                    className={`mb-4 ${formData.password.length >= 9 && passContents.cCase && passContents.lCase && passContents.num && passContents.symbol ? "hidden" : ""}`}
                >
                    <li>
                        <label>Password requires: </label>
                    </li>
                    <li className="ms-5">
                        <label
                            className={`${formData.password.length >= 9 ? "text-green-500" : "text-red-700"}`}
                        >
                            9 Size
                        </label>
                    </li>
                    <li className="ms-5">
                        <label
                            className={`${passContents.cCase ? "text-green-500" : "text-red-700"}`}
                        >
                            1 Capital Letter
                        </label>
                    </li>
                    <li className="ms-5">
                        <label
                            className={`${passContents.lCase ? "text-green-500" : "text-red-700"}`}
                        >
                            1 Lowercase Letter
                        </label>
                    </li>
                    <li className="ms-5">
                        <label
                            className={`${passContents.num ? "text-green-500" : "text-red-700"}`}
                        >
                            1 Number
                        </label>
                    </li>
                    <li className="ms-5">
                        <label
                            className={`${passContents.symbol ? "text-green-500" : "text-red-700"}`}
                        >
                            1 Symbol !@#$%^&*(),.?&lt;&gt;[]{}=-~`/
                        </label>
                    </li>
                ...
                />
                <label
                    className={`text-red-700 ${doPassMatch ? "hidden" : ""}`}
                >
