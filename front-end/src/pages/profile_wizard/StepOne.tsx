...
const StepOne: React.FC<Props> = ({
    ...
    const [input, setInput] = useState({
        ...
        shareEmail: formData.stepOne.shareEmail
            ? formData.stepOne.shareEmail
            : false,
    ...
    return (
        <div className="min-h-screen flex pt-16">
            ...
            <div className="w-1/2 flex flex-col items-center justify-center">
                <img
                    src="https://images.unsplash.com/photo-1523745962530-340c0eeb7e7d?q=80&w=1965&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt=""
                    className=""
                />
            </div>
            <div className="w-1/2 mx-auto my-auto p-8 px-20">
                <h1 className="text-4xl mb-4 font-bold">
                    Welcome {userContext ? userContext.name : ""}, Let's Get
                    Acquainted!
                </h1>
                ...
                <form>
                    <div className="mb-8">
                        <label className="text-base font-bold">
                            Bio
                            <p className="text-base font-normal mb-2 text-gray-400">
                    ...
                    <div className="mb-8">
                        <h3 className="text-2xl font-bold mb-6 mt-14 ">
                            Contact Information
                        </h3>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="font-normal text-gray-400">
                                If checked, your email will be visible to other
                                users.
                            </p>
                        </div>
                    </div>
